...
namespace CloudStack.Net
{
    public class IPAddressResponse
    {
        ...
        /// <summary>
        /// the name of the Network where ip belongs to
        /// </summary>
        ...
        /// <summary>
        /// State of the ip address. Can be: Allocating, Allocated, Releasing, Reserved and Free
        /// </summary>
        ...
        /// <summary>
        /// virtual machine type the ip address is assigned to
        /// </summary>
        ...
        /// <summary>
        /// VPC id the ip belongs to
        /// </summary>
        public string VpcId { get; set; }

        /// <summary>
        /// VPC name the ip belongs to
        /// </summary>
