...
{
    public class ListVnfTemplatesRequest : APIListRequest
    {
        public ListVnfTemplatesRequest() : base("listVnfTemplates") {}
    ...
    {
        ListResponse<TemplateResponse> ListVnfTemplates(ListVnfTemplatesRequest request);
        Task<ListResponse<TemplateResponse>> ListVnfTemplatesAsync(ListVnfTemplatesRequest request);
        ListResponse<TemplateResponse> ListVnfTemplatesAllPages(ListVnfTemplatesRequest request);
        Task<ListResponse<TemplateResponse>> ListVnfTemplatesAllPagesAsync(ListVnfTemplatesRequest request);
    }
    public partial class CloudStackAPIClient : ICloudStackAPIClient
    {
        public ListResponse<TemplateResponse> ListVnfTemplates(ListVnfTemplatesRequest request) => Proxy.Request<ListResponse<TemplateResponse>>(request);
        public Task<ListResponse<TemplateResponse>> ListVnfTemplatesAsync(ListVnfTemplatesRequest request) => Proxy.RequestAsync<ListResponse<TemplateResponse>>(request);
        public ListResponse<TemplateResponse> ListVnfTemplatesAllPages(ListVnfTemplatesRequest request) => Proxy.RequestAllPages<TemplateResponse>(request);
        public Task<ListResponse<TemplateResponse>> ListVnfTemplatesAllPagesAsync(ListVnfTemplatesRequest request) => Proxy.RequestAllPagesAsync<TemplateResponse>(request);
    }
}
