...
namespace CloudStack.Net
{
    public class MigrateVolumeRequest : APIRequest
    {
        ...
        /// </summary>
        public Guid? NewDiskOfferingId {
            get { return GetParameterValue<Guid?>(nameof(NewDiskOfferingId).ToLower()); }
            set { SetParameterValue(nameof(NewDiskOfferingId).ToLower(), value); }
        }
