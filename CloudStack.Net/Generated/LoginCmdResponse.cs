...
namespace CloudStack.Net
{
    public class LoginCmdResponse
    {
        ...
        /// </summary>
        public string Is2FAenabled { get; set; }

        /// <summary>
        /// Is two factor authentication verified
        /// </summary>
        public string Is2FAverified { get; set; }

        /// <summary>
        /// Two factor authentication issuer
        /// </summary>
        public string IssuerFor2FA { get; set; }
