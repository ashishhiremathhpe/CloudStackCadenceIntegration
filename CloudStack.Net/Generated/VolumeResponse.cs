...
namespace CloudStack.Net
{
    public class VolumeResponse
    {
        ...
        /// <summary>
        /// cluster id of the volume
        /// </summary>
        public string ClusterId { get; set; }

        /// <summary>
        /// cluster name where the volume is allocated
        /// </summary>
        ...
        /// <summary>
        /// IO requests read rate of the disk volume per the disk offering
        /// </summary>
        public long DiskIopsReadRate { get; set; }

        /// <summary>
        /// IO requests write rate of the disk volume per the disk offering
        /// </summary>
        ...
        /// <summary>
        /// volume uuid that is given by virtualisation provider (only for VMware)
        /// </summary>
        ...
        /// <summary>
        /// pod id of the volume
        /// </summary>
        public string PodId { get; set; }

        /// <summary>
        /// pod name of the volume
        /// </summary>
        ...
        /// <summary>
        /// true if storage snapshot is supported for the volume, false otherwise
        /// </summary>
        public bool SupportsStorageSnapshot { get; set; }
        ...
        /// <summary>
        /// the bytes actually consumed on disk
        /// </summary>
