...
{
    public class DeployVnfApplianceRequest : APIRequest
    {
        public DeployVnfApplianceRequest() : base("deployVnfAppliance") {}
        ...
        /// </summary>
        public IList<string> VnfCidrlist {
            get { return GetList<string>(nameof(VnfCidrlist).ToLower()); }
            set { SetParameterValue(nameof(VnfCidrlist).ToLower(), value); }
        }
        ...
        /// </summary>
        public bool? VnfConfigureManagement {
            get { return GetParameterValue<bool?>(nameof(VnfConfigureManagement).ToLower()); }
            set { SetParameterValue(nameof(VnfConfigureManagement).ToLower(), value); }
        }
    ...
    {
        AsyncJobResponse DeployVnfAppliance(DeployVnfApplianceRequest request);
        Task<AsyncJobResponse> DeployVnfApplianceAsync(DeployVnfApplianceRequest request);
    }
    public partial class CloudStackAPIClient : ICloudStackAPIClient
    {
        public AsyncJobResponse DeployVnfAppliance(DeployVnfApplianceRequest request) => Proxy.Request<AsyncJobResponse>(request);
        public Task<AsyncJobResponse> DeployVnfApplianceAsync(DeployVnfApplianceRequest request) => Proxy.RequestAsync<AsyncJobResponse>(request);
    }
}
