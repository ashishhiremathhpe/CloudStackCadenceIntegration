...
namespace CloudStack.Net
{
    ...
    {
        public ListResponse<AccountResponse> ListAccounts(ListAccountsRequest request) => Proxy.Request<ListResponse<AccountResponse>>(request);
        public Task<ListResponse<AccountResponse>> ListAccountsAsync(ListAccountsRequest request) => Proxy.RequestAsync<ListResponse<AccountResponse>>(request);
        public ListResponse<AccountResponse> ListAccountsAllPages(ListAccountsRequest request) => Proxy.RequestAllPages<AccountResponse>(request);
        public Task<ListResponse<AccountResponse>> ListAccountsAllPagesAsync(ListAccountsRequest request) => Proxy.RequestAllPagesAsync<AccountResponse>(request);
    }
}
