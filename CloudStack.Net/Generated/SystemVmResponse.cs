...
namespace CloudStack.Net
{
    public class SystemVmResponse
    {
        ...
        /// <summary>
        /// the agent state of the system VM
        /// </summary>
        ...
        /// <summary>
        /// the last disconnected date of host
        /// </summary>
        ...
        /// guest vlan range
        /// </summary>
        public string GuestVlan { get; set; }

        /// <summary>
        /// the control state of the host for the system VM
        /// </summary>
        ...
        /// <summary>
        /// the Pod name for the system VM
        /// </summary>
        ...
        /// public vlan range
        /// </summary>
        public IList<string> PublicVlan { get; set; }

        /// <summary>
        /// the ID of the service offering of the system virtual machine.
        /// </summary>
        public string ServiceOfferingId { get; set; }

        /// <summary>
        /// the name of the service offering of the system virtual machine.
        /// </summary>
        ...
        /// <summary>
        /// the template name for the system VM
        /// </summary>
        public string TemplateName { get; set; }

        /// <summary>
        /// the systemvm agent version
        /// </summary>
