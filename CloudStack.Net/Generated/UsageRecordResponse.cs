...
namespace CloudStack.Net
{
    public class UsageRecordResponse
    {
        ...
        /// <summary>
        /// resource or virtual machine name
        /// </summary>
        ...
        /// <summary>
        /// virtual machine guest os category ID
        /// </summary>
        public string OsCategoryId { get; set; }

        /// <summary>
        /// virtual machine os category name
        /// </summary>
        public string OsCategoryName { get; set; }

        /// <summary>
        /// virtual machine os display name
        /// </summary>
        public string OsDisplayName { get; set; }

        /// <summary>
        /// virtual machine os type ID
        /// </summary>
