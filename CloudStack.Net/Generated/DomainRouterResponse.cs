...
namespace CloudStack.Net
{
    public class DomainRouterResponse
    {
        ...
        /// <summary>
        /// true if any health checks had failed
        /// </summary>
        public bool HealthChecksFailed { get; set; }

        /// <summary>
        /// the control state of the host for the router
        /// </summary>
        ...
        /// <summary>
        /// the version of the code / software in the router
        /// </summary>
        ...
        /// <summary>
        /// the template name for the router
        /// </summary>
        ...
        /// <summary>
        /// Last executed health check result for the router
        /// </summary>
        public IList<RouterHealthCheckResultResponse> HealthCheckResults { get; set; }
