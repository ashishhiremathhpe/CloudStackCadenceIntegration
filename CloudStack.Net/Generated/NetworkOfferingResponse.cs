...
namespace CloudStack.Net
{
    public class NetworkOfferingResponse
    {
        ...
        /// <summary>
        /// true if network offering can be used by Tungsten-Fabric networks only
        /// </summary>
        public bool ForTungsten { get; set; }
        ...
        /// <summary>
        /// the internet protocol of the network offering
        /// </summary>
        ...
        /// <summary>
        /// true if network offering supports public access for guest networks
        /// </summary>
        public bool SupportsPublicAccess { get; set; }
