...
namespace CloudStack.Net
{
    ...
    {
        public AsyncJobResponse DeleteAutoScaleVmGroup(DeleteAutoScaleVmGroupRequest request) => Proxy.Request<AsyncJobResponse>(request);
        public Task<AsyncJobResponse> DeleteAutoScaleVmGroupAsync(DeleteAutoScaleVmGroupRequest request) => Proxy.RequestAsync<AsyncJobResponse>(request);
    }
}
