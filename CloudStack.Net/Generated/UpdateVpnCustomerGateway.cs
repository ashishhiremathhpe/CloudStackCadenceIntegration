...
namespace CloudStack.Net
{
    public class UpdateVpnCustomerGatewayRequest : APIRequest
    {
        ...
        public string IkeVersion {
            get { return GetParameterValue<string>(nameof(IkeVersion).ToLower()); }
            set { SetParameterValue(nameof(IkeVersion).ToLower(), value); }
        }
        ...
        /// </summary>
        public bool? SplitConnections {
            get { return GetParameterValue<bool?>(nameof(SplitConnections).ToLower()); }
            set { SetParameterValue(nameof(SplitConnections).ToLower(), value); }
        }
    ...
    {
        public AsyncJobResponse UpdateVpnCustomerGateway(UpdateVpnCustomerGatewayRequest request) => Proxy.Request<AsyncJobResponse>(request);
        public Task<AsyncJobResponse> UpdateVpnCustomerGatewayAsync(UpdateVpnCustomerGatewayRequest request) => Proxy.RequestAsync<AsyncJobResponse>(request);
    }
}
