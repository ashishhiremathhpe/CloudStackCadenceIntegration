...
{
    public class ListVolumesMetricsRequest : APIListRequest
    {
        public ListVolumesMetricsRequest() : base("listVolumesMetrics") {}
    ...
    {
        ListResponse<VolumeMetricsResponse> ListVolumesMetrics(ListVolumesMetricsRequest request);
        Task<ListResponse<VolumeMetricsResponse>> ListVolumesMetricsAsync(ListVolumesMetricsRequest request);
        ListResponse<VolumeMetricsResponse> ListVolumesMetricsAllPages(ListVolumesMetricsRequest request);
        Task<ListResponse<VolumeMetricsResponse>> ListVolumesMetricsAllPagesAsync(ListVolumesMetricsRequest request);
    }
    public partial class CloudStackAPIClient : ICloudStackAPIClient
    {
        public ListResponse<VolumeMetricsResponse> ListVolumesMetrics(ListVolumesMetricsRequest request) => Proxy.Request<ListResponse<VolumeMetricsResponse>>(request);
        public Task<ListResponse<VolumeMetricsResponse>> ListVolumesMetricsAsync(ListVolumesMetricsRequest request) => Proxy.RequestAsync<ListResponse<VolumeMetricsResponse>>(request);
        public ListResponse<VolumeMetricsResponse> ListVolumesMetricsAllPages(ListVolumesMetricsRequest request) => Proxy.RequestAllPages<VolumeMetricsResponse>(request);
        public Task<ListResponse<VolumeMetricsResponse>> ListVolumesMetricsAllPagesAsync(ListVolumesMetricsRequest request) => Proxy.RequestAllPagesAsync<VolumeMetricsResponse>(request);
    }
}
