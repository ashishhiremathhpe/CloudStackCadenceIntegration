...
namespace CloudStack.Net
{
    public class FirewallResponse
    {
        ...
        /// <summary>
        /// the cidr list to forward traffic from. Multiple entries are separated by a single comma character (,).
        /// </summary>
        public string CidrList { get; set; }

        /// <summary>
        /// the cidr list to forward traffic to. Multiple entries are separated by a single comma character (,).
        /// </summary>
        public string Destcidrlist { get; set; }
        ...
        /// <summary>
        /// the traffic type for the firewall rule
        /// </summary>
