...
namespace CloudStack.Net
{
    public class LoadBalancerResponse
    {
        ...
        /// <summary>
        /// the CIDR list to allow traffic, all other CIDRs will be blocked. Multiple entries must be separated by a single comma character (,).
        /// </summary>
        ...
        /// <summary>
        /// the name of the zone the load balancer rule belongs to
        /// </summary>
