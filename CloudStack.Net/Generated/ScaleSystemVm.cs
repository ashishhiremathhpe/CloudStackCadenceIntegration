...
namespace CloudStack.Net
{
    ...
    {
        public AsyncJobResponse ScaleSystemVm(ScaleSystemVmRequest request) => Proxy.Request<AsyncJobResponse>(request);
        public Task<AsyncJobResponse> ScaleSystemVmAsync(ScaleSystemVmRequest request) => Proxy.RequestAsync<AsyncJobResponse>(request);
    }
}
