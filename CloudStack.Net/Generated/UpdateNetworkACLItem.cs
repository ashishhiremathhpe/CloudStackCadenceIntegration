...
namespace CloudStack.Net
{
    public class UpdateNetworkACLItemRequest : APIRequest
    {
        ...
        /// </summary>
        public bool? PartialUpgrade {
            get { return GetParameterValue<bool?>(nameof(PartialUpgrade).ToLower()); }
            set { SetParameterValue(nameof(PartialUpgrade).ToLower(), value); }
        }
        ...
        public string Reason {
            get { return GetParameterValue<string>(nameof(Reason).ToLower()); }
            set { SetParameterValue(nameof(Reason).ToLower(), value); }
        }
    ...
    {
        public AsyncJobResponse UpdateNetworkACLItem(UpdateNetworkACLItemRequest request) => Proxy.Request<AsyncJobResponse>(request);
        public Task<AsyncJobResponse> UpdateNetworkACLItemAsync(UpdateNetworkACLItemRequest request) => Proxy.RequestAsync<AsyncJobResponse>(request);
    }
}
