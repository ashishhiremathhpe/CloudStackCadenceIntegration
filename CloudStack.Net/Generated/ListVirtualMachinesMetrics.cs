...
{
    public class ListVirtualMachinesMetricsRequest : APIListRequest
    {
        public ListVirtualMachinesMetricsRequest() : base("listVirtualMachinesMetrics") {}
    ...
    {
        ListResponse<VmMetricsResponse> ListVirtualMachinesMetrics(ListVirtualMachinesMetricsRequest request);
        Task<ListResponse<VmMetricsResponse>> ListVirtualMachinesMetricsAsync(ListVirtualMachinesMetricsRequest request);
        ListResponse<VmMetricsResponse> ListVirtualMachinesMetricsAllPages(ListVirtualMachinesMetricsRequest request);
        Task<ListResponse<VmMetricsResponse>> ListVirtualMachinesMetricsAllPagesAsync(ListVirtualMachinesMetricsRequest request);
    }
    public partial class CloudStackAPIClient : ICloudStackAPIClient
    {
        public ListResponse<VmMetricsResponse> ListVirtualMachinesMetrics(ListVirtualMachinesMetricsRequest request) => Proxy.Request<ListResponse<VmMetricsResponse>>(request);
        public Task<ListResponse<VmMetricsResponse>> ListVirtualMachinesMetricsAsync(ListVirtualMachinesMetricsRequest request) => Proxy.RequestAsync<ListResponse<VmMetricsResponse>>(request);
        public ListResponse<VmMetricsResponse> ListVirtualMachinesMetricsAllPages(ListVirtualMachinesMetricsRequest request) => Proxy.RequestAllPages<VmMetricsResponse>(request);
        public Task<ListResponse<VmMetricsResponse>> ListVirtualMachinesMetricsAllPagesAsync(ListVirtualMachinesMetricsRequest request) => Proxy.RequestAllPagesAsync<VmMetricsResponse>(request);
    }
}
